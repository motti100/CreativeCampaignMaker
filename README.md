...
Setup
bashgit clone https://github.com/YOUR_USERNAME/creative-campaign-maker.git
...
Generate "smartphone on desk"
Refine: "marble surface"
Refine: "dramatic lighting"
Done - all changes preserved

Troubleshooting
Invalid API Key
bashcat .env | grep BRIA_API_KEY
# No quotes, no spaces
Gateway Timeout
Normal on first request. Auto-retries. Takes 20-30 seconds.
Module errors
bashpip install -r requirements.txt --force-reinstall
Documentation
